...
The runtime schema lists stable top-level JSON field names for `agent_context`, `clock`, `catalog`, `status`, `tuner`, `frontend`, `session`, `event`, `scenario`, `mux`, and `service` models.
