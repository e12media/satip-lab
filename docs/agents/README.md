...
- Feature flags for custom catalogs, compatibility profiles, XMLTV, EIT present/following, frontend telemetry, RTSP interleaved TCP, RTSP/RTP smoke, and runtime scenarios.
